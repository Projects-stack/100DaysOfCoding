...
/*  A tree is a nonlinear hierarchical data structure that consists of nodes connected by edges.
    ...
    Why Tree Data Structure?
        ...
        time complexity increases with the increase in the data size. But, it is not acceptable in today's
        computational world. Different tree data structures allow quicker and easier access to the data as
    ...
    Tree Terminologies
        ...
        Node ->
                A node is an entity that contains a key or value and pointers to its child nodes.The last nodes
            of each path are called leaf nodes or external nodes that do not contain a link/pointer to child nodes.
        ...
        Height of a Node ->
                The height of a node is the number of edges from the node to the deepest leaf (that is the longest path
